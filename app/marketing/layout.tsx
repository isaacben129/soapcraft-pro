...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://soapcraft-pro.vercel.app/marketing",
  ...
  alternates: {
    canonical: "https://soapcraft-pro.vercel.app/marketing",
  },
};
    ...
    <html lang="en" className="font-sans">
      <body className="min-h-screen bg-background text-foreground antialiased">
        <div className="flex min-h-screen flex-col">
          {/* Marketing header */}
          <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 ">
