...
export const metadata: Metadata = { title: "Wholesale Pricing Calculator | SoapCraft Pro", description: "Calculate wholesale and retail price scenarios from your real soap cost.", alternates: { canonical: "/tools/wholesale-pricing" } };
